...
export default function AboutUs() {
    return (
        <div className="">
            ...
            <p className="rounded-3xl text-center text-lg p-10 m-5 bg-gray-300 shadow-xl">When we first started our fitness journey, the biggest roadblock we all encountered was not knowing where to begin. We needed help figuring out which exercises to do and what foods to eat. Even with research, the abundance of resources made it overwhelming to choose a direction. Creating a simple schedule to stick to proved crucial in keeping us motivated, ultimately inspiring us to create GymBro.</p>
            <br></br>
            <hr class="my-4 border-gray-400 sm:mx-auto lg:my-6 w-1/2"/>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">

                <div className="bg-gray-300 shadow-md rounded p-4 ml-3">
                ...
                <div className="bg-gray-300 shadow-md rounded p-4 mr-3">
